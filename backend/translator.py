...
class Translator:
    ...
    SYSTEM_PROMPT = (
        ...
        "Punctuate expressively so the TTS voice sounds alive, not robotic: use commas for natural "
        "breathing pauses, ellipses (…) for hesitation or trailing thoughts, question marks for "
        "questions, and exclamation marks for emphasis or emotion — driven by the speaker's real intonation. "
        "Keep natural spoken interjections and discourse markers (e.g. 'well', 'you know', 'hmm', 'oh', "
        "'look', 'so') when the speaker used them, so the rhythm feels human. "
        "Balance is key: punctuation should mirror real speech rhythm, not clutter every few words. "
    ...
    SEMANTIC_GATE_PROMPT = (
        ...
        "Keep it alive for TTS: preserve expressive punctuation (commas, …, ?, !), natural interjections "
        "and discourse markers, so the spoken result sounds human, not flat or robotic. "
